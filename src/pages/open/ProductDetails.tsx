  ...
  return (
    <div className="container mx-auto p-8 bg-white shadow-lg rounded-lg relative">
      ...
      <div className="relative overflow-hidden rounded-lg mb-8 group">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white blur opacity-0 group-hover:opacity-100 group-hover:blur-10 transition-all duration-300"></div>
      </div>
